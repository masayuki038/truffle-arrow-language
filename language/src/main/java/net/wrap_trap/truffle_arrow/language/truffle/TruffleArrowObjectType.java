...
public class TruffleArrowObjectType extends ObjectType {

  protected static final int CACHE_LIMIT = 3;
  public static final TruffleArrowObjectType SINGLETON = new TruffleArrowObjectType();

  @Override
  public Class<?> dispatch() {
    return TruffleArrowObjectType.class;
  }
  ...
  static Object getMetaObject(DynamicObject receiver) {
    return TruffleArrowType.OBJECT;
  }
